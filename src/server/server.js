...
const getRequest=async(url)=>{
    try{
        let res=await fetch(`${SERVER_URL}${url}`,{
            method:"GET",
            headers:{"content-type":"application/json",auth_token:localStorage.getItem("user_auth")}
        })
        res=await res.json();
        return res;
    }
...
export {SERVER_URL,authenticationRequest,getRequest,postRequest,deleteRequest,CLIENT_ID};